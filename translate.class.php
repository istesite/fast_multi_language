...
class translate {
	...
	function getLanguageByCode($langCode) {
		$langs = array('af'=> 'Afrikanca',	'am'=> 'Amharca',	'ar'=> 'Arapça',	'az'=> 'Azerice',	'ba'=> 'Başkurtça',
		               'be'=> 'Belarusça',	'bg'=> 'Bulgarca',	'bn'=> 'Bengalce',	'bs'=> 'Boşnakça',	'ca'=> 'Katalanca',
		               'ceb' => 'Sabuanca',	'cs'=> 'Çekçe',	'cy'=> 'Gal dili',	'da'=> 'Danca',	'de'=> 'Almanca',
		               'el'=> 'Yunanca',	'en'=> 'İngilizce',	'eo'=> 'Esperanto',	'es'=> 'İspanyolca',	'et'=> 'Estonca',
		               'eu'=> 'Baskça',	'fa'=> 'Farsça',	'fi'=> 'Fince',	'fr'=> 'Fransızca',	'ga'=> 'İrlandaca',
		               'gd'=> 'İskoçça (Kelt dili)',	'gl'=> 'Galiçyaca',	'gu'=> 'Gucaratça',	'he'=> 'İbranice',	'hi'=> 'Hintçe',
		               'hr'=> 'Hırvatça',	'ht'=> 'Haiti dili',	'hu'=> 'Macarca',	'hy'=> 'Ermenice',	'id'=> 'Endonezce',
		               'is'=> 'İzlandaca',	'it'=> 'İtalyanca',	'ja'=> 'Japonca',	'jv'=> 'Cava dili',	'ka'=> 'Gürcüce',
		               'kk'=> 'Kazakça',	'km'=> 'Khmerce',	'kn'=> 'Kannada dili',	'ko'=> 'Korece',	'ky'=> 'Kırgızca',
		               'la'=> 'Latince',	'lb'=> 'Lüksemburgca',	'lo'=> 'Laoca',	'lt'=> 'Litvanca',	'lv'=> 'Letonca',
		               'mg'=> 'Malgaşça',	'mhr' => 'Mari dili',	'mi'=> 'Maorice',	'mk'=> 'Makedonca',	'ml'=> 'Malayalamca',
		               'mn'=> 'Moğolca',	'mr'=> 'Marathi',	'mrj' => 'Batı Mari dili',	'ms'=> 'Malayca',	'mt'=> 'Maltaca',
		               'my'=> 'Birmanca',	'ne'=> 'Nepali',	'nl'=> 'Felemenkçe',	'no'=> 'Norveççe',	'pa'=> 'Pencapça',
		               'pap' => 'Papiamento',	'pl'=> 'Lehçe',	'pt'=> 'Portekizce',	'ro'=> 'Romence',	'ru'=> 'Rusça',
		               'si'=> 'Seylanca',	'sk'=> 'Slovakça',	'sl'=> 'Slovence',	'sq'=> 'Arnavutça',	'sr'=> 'Sırpça',
		               'su'=> 'Sundaca',	'sv'=> 'İsveçce',	'sw'=> 'Svahili',	'ta'=> 'Tamilce',	'te'=> 'Teluguca',
		               'tg'=> 'Tacikçe',	'th'=> 'Taylandça',	'tl'=> 'Tagalogca',	'tr'=> 'Türkçe',	'tt'=> 'Tatarca',
		               'udm' => 'Udmurtça',	'uk'=> 'Ukraynaca',	'ur'=> 'Urduca',	'uz'=> 'Özbekçe',	'vi'=> 'Vietnamca',
		               'xh'=> 'Xhosa dili',	'yi'=> 'Yidiş',	'zh'=> 'Çince');
